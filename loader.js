...
var runGrafar = function(callback, pathOverride) {
<<<<<<< HEAD
	$LAB.setOptions(pathOverride == ''? {}: {BasePath: (pathOverride || 'js/')})
		.script('libs/three.min.js').wait(function() {console.log(pathOverride);})
=======
	$LAB.setOptions({BasePath: (pathOverride === undefined? 'js/': pathOverride)})
		.script('libs/three.min.js')
>>>>>>> origin/feature-refactoring
		.script('libs/stats.min.js')
		.script('libs/Detector.js')
		.script('libs/OrbitControls.js')		
