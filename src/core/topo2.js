var arrUtils = require('../math/array_utils.js');
var incArray = arrUtils.incArray;
var timesArray = arrUtils.timesArray;


var resizeBuffer = function (buffer, size) {
    var type = buffer.array.constructor;
    buffer.array = new type(size);
    buffer.length = size;
    return buffer;
};
...
module.exports = {
	...
	pathGraph: pathGraph,
	cartesianGraphProd: cartesianGraphProd,
	makeFaces: makeFaces
};
